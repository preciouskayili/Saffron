<!-- Footer -->
<footer class="page-footer font-small special-color-dark pt-4" style="background-color: #779add;">  
    <div class="container">
        <div class="row">
            <div class="col-md-6 mb-4">
                <h3 class="text-responsive">About Us</h3>
                <p class="text-muted">We make flight booking very easy, secured and fast. With few easy steps your flight booking will
                be done in a matter of minutes. If you want an easy and reliable way to book your flights then SAFFRON is the right 
                place for you. Fly better...</p>
            </div>
            <div class="col-md-6 mb-4">
    ...
    <div class="footer-copyright text-center py-3">© <?php echo date('Y'); ?> Copyright:
        <a href="https://index.com/">Saffron</a>
    </div>
</footer>