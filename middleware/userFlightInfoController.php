<?php
    ...
    if (isset($_GET['submit'])) {
        ...
        $sql = "INSERT INTO contact_information(flight_id,name,surname,phone_number,email,gender,date_of_birth,flying_from,flying_to) VALUES('$flight_id','$name','$surname','$phone_number','$email','$gender','$date_of_birth','$flying_from', '$flying_to')";
